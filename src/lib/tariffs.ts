...
// Депозит (если работодатель его включил) = 15% от указанной суммы.
...
export const DEPOSIT_RATE = 0.15; // 15% суммы вознаграждения — вносится при публикации, если депозит включён
