...
// Симуляция парсинга резюме — как в исходном прототипе (CvUpload): реального
// разбора файла нет, поля заполняются правдоподобными случайными значениями,
// чтобы показать сценарий "загрузили файл → анкета заполнилась сама".
